...
- Start with the [Hello, Grace](/docs/guides/hello-grace) tutorial
- Learn how [grace.yml](/docs/category/yaml-specification) is structured
- Explore the [CLI reference](/docs/category/cli-reference)
